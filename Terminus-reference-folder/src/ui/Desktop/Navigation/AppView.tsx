...
import { LocalTerminal } from "@/ui/Desktop/Apps/Terminal/LocalTerminal.tsx";
...
export function AppView({
  ...
  }, [allSplitScreenTab.length, isTopbarOpen, resetKey]);
  ...
  useEffect(() => {
    ...
    updateTabBarHeight();
    // Beobachte Änderungen an der CSS-Variable
  ...
  const topMarginPx = isTopbarOpen ? tabBarHeightPx : 0;
